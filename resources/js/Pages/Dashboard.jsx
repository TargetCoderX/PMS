...
export default function Dashboard() {
    ...
    useEffect(() => {
        dispatch(addHeaderText("Dashboard"));
        dispatch(addHeaderSubtext("Welcome to your dashboard"));
                        ...
                        <div className="card-table table-responsive">
                            <table className="table table-vcenter">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="w-1">
                                            <span className="avatar avatar-sm" style={{ backgroundImage: 'url(./static/avatars/002m.jpg)' }} />
                                        </td>
                                        <td className="td-truncate">
                                            <div className="text-truncate">
                                    ...
                                    <tr>
                                        <td className="w-1">
                                            <span className="avatar avatar-sm" style={{ backgroundImage: 'url(./static/avatars/003m.jpg)' }} />
                                        </td>
                                        <td className="td-truncate">
                                            <div className="text-truncate">
                                    ...
                                    <tr>
                                        <td className="w-1">
                                            <span className="avatar avatar-sm" style={{ backgroundImage: 'url(./static/avatars/000f.jpg)' }} />
                                        </td>
                                        <td className="td-truncate">
                                            <div className="text-truncate">
                        ...
                        <div className="card-body">
                            <div className="row align-items-center">
                                <div className="col-10">
                                    ...
                                    <div className="mt-3">
                                        <a href="https://tabler-icons.io" className="btn btn-primary" target="_blank" rel="noopener">Download icons</a>
                                    </div>
                                </div>
                            </div>
                        </div>
